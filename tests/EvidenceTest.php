...
final class EvidenceTest extends TestCase
{
    ...
    public static function proveInt(mixed $value, O\Option $expected): void
    {
        assertEquals(
            $expected,
    ...
    public static function proveFloat(mixed $value, O\Option $expected): void
    {
        assertEquals(
            $expected,
    ...
    public static function proveString(mixed $value, O\Option $expected): void
    {
        assertEquals(
            $expected,
    ...
    public static function proveNonEmptyString(mixed $value, O\Option $expected): void
    {
        assertEquals(
            $expected,
    ...
    public static function proveBool(mixed $value, O\Option $expected): void
    {
        assertEquals(
            $expected,
    ...
    public static function proveNull(mixed $value, O\Option $expected): void
    {
        assertEquals(
            $expected,
    ...
    public static function proveObject(mixed $value, O\Option $expected): void
    {
        assertEquals(
            $expected,
