...
final class OptionTest extends TestCase
{
    ...
    public static function tap(): void
    {
        ...
        pipe(
            ...
            Type\isSameAs('O\Option<stdClass>'),
            Assert\instance(O\Some::class),
        );
    ...
    public static function filter(string|int $stringOrInt = 42): void
    {
        ...
        pipe(
            ...
            Type\isSameAs('O\Option<int<0, 100>>'),
            Assert\equals(O\some(42)),
        );
        ...
        pipe(
            O\some(42),
            O\filter(fn($i) => $i > 42),
            Type\isSameAs('O\Option<int<43, max>>'),
            Assert\equals(O\none),
        );
    }
    ...
    public static function bind(): void
    {
        pipe(
            ...
            Type\isSameAs('O\Option<Bindable<object{a: int, b: never}>>'),
            Assert\equals(O\none),
        );
        ...
        pipe(
            ...
            Type\isSameAs('O\Option<Bindable<object{a: int, b: never, c: int}>>'),
            Assert\equals(O\none),
        );
        ...
        pipe(
            ...
            Type\isSameAs('O\Option<Bindable<object{a: int, b: int}>>'),
            O\map(fn($i) => $i->a + $i->b),
            Type\isSameAs('O\Option<int>'),
            Assert\equals(O\some(42)),
        );
        ...
        pipe(
            ...
            Type\isSameAs('O\Option<Bindable<object{a: int, b: int, c: int}>>'),
            O\map(fn($i) => $i->c),
            Type\isSameAs('O\Option<int>'),
            Assert\equals(O\some(42)),
        );
    ...
    public static function let(): void
    {
        pipe(
            ...
            O\let(c: fn() => 42),
            Type\isAssignableTo('O\Option<Bindable<object{a: int, b: never, c: int}>>'),
            Assert\equals(O\none),
        );
        ...
        pipe(
            ...
            Type\isAssignableTo('O\Option<Bindable<object{a: int, b: int}>>'),
            O\map(fn($i) => $i->a + $i->b),
            Type\isAssignableTo('O\Option<int>'),
            Assert\equals(O\some(42)),
        );
        ...
        pipe(
            ...
            Type\isAssignableTo('O\Option<Bindable<object{a: int, b: int, c: int}>>'),
            O\map(fn($i) => $i->c),
            Type\isAssignableTo('O\Option<int>'),
            Assert\equals(O\some(42)),
        );
